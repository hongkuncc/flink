package com.hongkuncc.hotitems_analysis
...
object KafkaProducerUtil {
  ...
  def writeToKakfaWithTopic(topic: String): Unit ={
    ...
    // 从文件中读取数据，逐条发送
    val bufferedSource = io.Source.fromFile("E:\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
